...
public class DpLCS {
    ...
    public static int lcsMemoi(String str1, String str2, int n, int m, int dp[][]) {
        if(n==0 || m==0) {
            return 0;
        }
        if(dp[n][m] != -1) {
        ...
        if(str1.charAt(n-1) == str2.charAt(m-1)) {
            return dp[n][m] = lcsMemoi(str1, str2, n-1, m-1, dp) + 1;
        } else {
    ...
    public static int lcsTabular(String str1, String str2) {
        int n = str1.length();
        int m = str2.length();
    ...
    public static void main(String[] args) {
        ...
        //     }
        // }
        // System.out.println(lcsMemoi(str1, str2, n, m, dp));
